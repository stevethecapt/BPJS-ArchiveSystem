...
$query = "SELECT * FROM arsip WHERE jadwal_aktif <= CURDATE() AND jadwal_inaktif > CURDATE() ORDER BY id ASC";
...
<body>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5" class="text-center">Tidak ada arsip aktif saat ini.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="btn-container">
            ...
            <?php if (!empty($arsip_aktif)) : ?>
                <a href="../export_excel.php?id=<?= urlencode($arsip_aktif[0]['id']); ?>" class="btn-success">Download</a>
            <?php endif; ?>
        </div>
    </div>
