...
<body>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="6" class="text-center">Tidak ada arsip aktif.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="btn-container">
            <a href="detail.php?type=aktif" class="btn-info">Detail</a>
            <a href="../export_excel.php?status=aktif" class="btn-success">Download</a>
        </div>
    </div>
